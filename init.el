...
(defun dotspacemacs/user-config ()
  ...
  (add-to-list 'org-roam-capture-templates
               '("c" "characters" plain (function org-roam-capture--get-point)
                 "\n- 生卒年:\n* 成就\n* 影响"
  ...
  (setq-default org-agenda-dir "/home/diphia/org-files/gtd/")
  ...
  (setq org-capture-templates
        '(
          ("t" "Work" entry (file+headline org-agenda-file-task "Work")
           "* TODO [#B] %?\n  %i\n"
           :empty-lines 1)
          ("s" "Study" entry (file+headline org-agenda-file-task "Learning")
           "* TODO [#B] %?\n  %i\n"
           :empty-lines 1)
          ("o" "Others" entry (file+headline org-agenda-file-task "Others")
           "* TODO [#C] %?\n  %i\n"
           :empty-lines 1)
